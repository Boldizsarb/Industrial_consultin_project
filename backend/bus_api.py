def calculate_bus_emissions_standardized(distance_miles, co2_per_mile_per_person=100):
...
emission_per_passenger = calculate_bus_emissions_standardized(distance_miles)
